// src/theme/customizations/inputs.jsx
 ...
 * Notes:
 * - Replaced TS helpers:
 *   - outlinedInputClasses.focused     -> ".Mui-focused"
 *   - toggleButtonGroupClasses.selected -> ".MuiToggleButton-root.Mui-selected"
 *   - toggleButtonClasses.selected      -> "&.Mui-selected"
 *   - svgIconClasses.root               -> ".MuiSvgIcon-root"
 * - Moved "variants" into components.MuiX.variants (MUI-supported) instead of inside styleOverrides.
 * - Guarded theme.applyStyles (works on MUI v5 and v6).
 */
        ...
        style: ({ theme }) => ({
          ...
          ...(theme.applyStyles
            ? theme.applyStyles('dark', {
                ...
                '&:hover': { backgroundImage: 'none', backgroundColor: gray[300], boxShadow: 'none' },
    ...
    variants: [
      {
        ...
        style: {
          ...
          height: '2.25rem',
          padding: '0.25rem',
          '& .MuiSvgIcon-root': { fontSize: '1rem' }, // (was svgIconClasses.root)
        },
      },
      {
        props: { size: 'medium' },
  ...
  MuiToggleButtonGroup: {
    styleOverrides: {
      root: ({ theme }) => ({
        ...
        // selected buttons inside the group:
      ...
      root: ({ theme }) => ({
        ...
        ...(theme.applyStyles
          ? theme.applyStyles('dark', {
              ...
              '&.Mui-selected': { color: brand[300] }, // (was toggleButtonClasses.selected)
            })
          : theme.palette.mode === 'dark'
          ? {
              color: gray[400],
  ...
  MuiOutlinedInput: {
    styleOverrides: {
      ...
      root: ({ theme }) => ({
        ...
        '&.Mui-focused': {
          // (was outlinedInputClasses.focused)
          outline: `3px solid ${alpha(brand[500], 0.5)}`,
          borderColor: brand[400],
        },
        ...(theme.applyStyles
