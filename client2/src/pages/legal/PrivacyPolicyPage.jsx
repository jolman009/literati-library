      ...
      <MD3Card className="legal-content-card">
        <div className="legal-content">
          <section className="legal-section">
            <h2 className="md-headline-medium">Introduction</h2>
          ...
          <section className="legal-section">
            <h2 className="md-headline-medium">Information We Collect</h2>
          ...
          <section className="legal-section">
            <h2 className="md-headline-medium">How We Use Your Information</h2>
          ...
          <section className="legal-section">
            <h2 className="md-headline-medium">Information Sharing</h2>
            <p className="md-body-medium">
          ...
          <section className="legal-section">
            <h2 className="md-headline-medium">Your Privacy Rights</h2>
          ...
          <section className="legal-section">
            <h2 className="md-headline-medium">Data Security</h2>
          ...
          <section className="legal-section">
            <h2 className="md-headline-medium">Data Retention</h2>
